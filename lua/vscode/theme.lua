...
theme.set_highlights = function(opts)
    ...
    hl(0, 'NonText', { fg = (isDark and c.vsc2017Whitespace or c.vscTabOther), bg = c.vscNone })
    ...
    hl(0, 'Identifier', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'Function', { fg = c.vsc2017Func, bg = 'NONE' })
    ...
    hl(0, 'Whitespace', { fg = isDark and c.vsc2017Whitespace or c.vscTabOther })
    ...
    hl(0, '@constant', { fg = c.vsc2017Var, bg = 'NONE' })
    ...
    hl(0, '@boolean', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@annotation', { fg = c.vsc2017Func, bg = 'NONE' })
    hl(0, '@attribute', { fg = c.vsc2017Func, bg = 'NONE' })
    hl(0, '@attribute.builtin', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, '@module', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, '@function', { fg = c.vsc2017Func, bg = 'NONE' })
    hl(0, '@function.builtin', { fg = c.vsc2017Func, bg = 'NONE' })
    hl(0, '@function.macro', { fg = c.vsc2017Func, bg = 'NONE' })
    ...
    hl(0, '@property', { fg = c.vsc2017Property, bg = 'NONE' })
    hl(0, '@constructor', { fg = c.vsc2017Func, bg = 'NONE' })
    hl(0, '@label', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, '@keyword', { fg = c.vscBlue, bg = 'NONE' })
    ...
    hl(0, '@lsp.type.enumMember', { fg = c.vsc2017EnumMember, bg = 'NONE' })
    ...
    -- JSON
    hl(0, 'jsonKeyword', { fg = c.vsc2017Property, bg = 'NONE' })
    ...
    hl(0, 'cssProp', { fg = c.vsc2017Property, bg = 'NONE' })
    hl(0, 'cssDefinition', { fg = c.vsc2017Property, bg = 'NONE' })
    ...
    hl(0, 'cssStyle', { fg = c.vsc2017Property, bg = 'NONE' })
    hl(0, 'cssImportant', { fg = c.vscBlue, bg = 'NONE' })

    -- JavaScript
    hl(0, 'jsVariableDef', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'jsFuncArgs', { fg = c.vsc2017Param, bg = 'NONE' })
    hl(0, 'jsFuncBlock', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'jsRegexpString', { fg = c.vscLightRed, bg = 'NONE' })
    hl(0, 'jsThis', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'jsOperatorKeyword', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'jsDestructuringBlock', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'jsObjectKey', { fg = c.vsc2017Property, bg = 'NONE' })
    hl(0, 'jsGlobalObjects', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'jsModuleKeyword', { fg = c.vsc2017Var, bg = 'NONE' })
    ...
    hl(0, 'jsFuncCall', { fg = c.vsc2017Func, bg = 'NONE' })
    hl(0, 'jsObjectValue', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'jsParen', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'jsObjectProp', { fg = c.vsc2017Property, bg = 'NONE' })
    hl(0, 'jsIfElseBlock', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'jsParenIfElse', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'jsSpreadOperator', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'jsSpreadExpression', { fg = c.vsc2017Var, bg = 'NONE' })

    -- Typescript
    hl(0, '@type.builtin.typescript', { link = '@type' })
    hl(0, '@type.builtin.tsx', { link = '@type' })
    hl(0, 'typescriptLabel', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'typescriptExceptions', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'typescriptBraces', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptEndColons', { fg = c.vsc2017Var, bg = 'NONE' })
    ...
    hl(0, 'typescriptLogicSymbols', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'typescriptImport', { fg = c.vscPink, bg = 'NONE' })
    hl(0, 'typescriptBOM', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'typescriptVariableDeclaration', { fg = c.vsc2017Var, bg = 'NONE' })
    ...
    hl(0, 'typescriptMember', { fg = c.vsc2017Func, bg = 'NONE' })
    hl(0, 'typescriptTypeReference', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'typescriptTemplateSB', { fg = c.vscYellowOrange, bg = 'NONE' })
    hl(0, 'typescriptArrowFuncArg', { fg = c.vsc2017Param, bg = 'NONE' })
    hl(0, 'typescriptParamImpl', { fg = c.vsc2017Param, bg = 'NONE' })
    hl(0, 'typescriptFuncComma', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'typescriptCastKeyword', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'typescriptCall', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'typescriptCase', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'typescriptReserved', { fg = c.vscPink, bg = 'NONE' })
    hl(0, 'typescriptDefault', { fg = c.vsc2017Var, bg = 'NONE' })
    ...
    hl(0, 'typescriptBlock', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'typescriptDOMDocProp', { fg = c.vsc2017Property, bg = 'NONE' })
    hl(0, 'typescriptTemplateSubstitution', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'typescriptClassBlock', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'typescriptFuncCallArg', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'typescriptIndexExpr', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'typescriptConditionalParen', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'typescriptArray', { fg = c.vscYellow, bg = 'NONE' })
    hl(0, 'typescriptES6SetProp', { fg = c.vsc2017Property, bg = 'NONE' })
    hl(0, 'typescriptObjectLiteral', { fg = c.vsc2017Var, bg = 'NONE' })
    ...
    hl(0, 'typescriptLoopParen', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'typescriptParenExp', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'typescriptModule', { fg = c.vsc2017Var, bg = 'NONE' })
    ...
    hl(0, 'typescriptGlobalMethod', { fg = c.vsc2017Func, bg = 'NONE' })
    hl(0, 'typescriptPromiseMethod', { fg = c.vsc2017Func, bg = 'NONE' })
    ...
    hl(0, 'goBuiltins', { fg = c.vsc2017Func, bg = 'NONE' })
    ...
    hl(0, 'goVarAssign', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'goVarDefs', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'goReceiver', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'goReceiverType', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'goFunctionCall', { fg = c.vsc2017Func, bg = 'NONE' })
    hl(0, 'goMethodCall', { fg = c.vsc2017Func, bg = 'NONE' })
    hl(0, 'goSingleDecl', { fg = c.vsc2017Var, bg = 'NONE' })
    ...
    hl(0, 'pythonBuiltinObj', { fg = c.vsc2017Var, bg = 'NONE' })
    ...
    hl(0, 'texBeginEnd', { fg = c.vsc2017Func, bg = 'NONE' })
    hl(0, 'texBeginEndName', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'texOption', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'texBeginEndModifier', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'texDocType', { fg = c.vscPink, bg = 'NONE' })
    hl(0, 'texDocTypeArgs', { fg = c.vsc2017Var, bg = 'NONE' })
    ...
    -- Lua
    hl(0, 'luaFuncCall', { fg = c.vsc2017Func, bg = 'NONE' })
    hl(0, 'luaFuncArgName', { fg = c.vsc2017Param, bg = 'NONE' })
    hl(0, 'luaFuncKeyword', { fg = c.vscPink, bg = 'NONE' })
    hl(0, 'luaLocal', { fg = c.vscPink, bg = 'NONE' })
    hl(0, 'luaBuiltIn', { fg = c.vscBlue, bg = 'NONE' })

    -- SH
    hl(0, 'shDeref', { fg = c.vsc2017Var, bg = 'NONE' })
    hl(0, 'shVariable', { fg = c.vsc2017Var, bg = 'NONE' })
    ...
    hl(0, 'DiagnosticUnnecessary', { fg = c.vscGray, bg = 'NONE' })
